...
! function (a) {
  ...
  b.version = "5.0.0", b.PI = Math.PI, b.A90 = Math.PI / 2, b.isTouch = !1, b.corners = {
          ...
          forward: ["br", "tr", "r"],
          all: ["tl", "bl", "tr", "br", "l", "r"]
      }, b.DISPLAY_SINGLE = 1, b.DISPLAY_DOUBLE = 2, b.DIRECTION_LTR = 1, b.DIRECTION_RTL = 2, b.EVENT_PREVENTED = 1,
      b.EVENT_STOPPED = 2, b.fragStatus = {
          assigned: 0,
          requested: 1,
          waiting: 2,
          nsplit: 6,
          ...
          for (var a = ["Moz", "Webkit", "Khtml", "O", "ms"], b = a.length, c = ""; b--;) a[b] + "Transform" in
              document.body.style && (c = "-" + a[b].toLowerCase() + "-");
          return c
          ...
          return window.getSelection ? window.getSelection().toString() : document.selection.createRange ? document.selection
              .createRange().text : void 0
      }, b.bezier = function (a, b, c) {
          var d = 1 - b,
              e = d * d * d,
              f = b * b * b;
          return this.peelingPoint(c, Math.round(e * a[0].x + 3 * b * d * d * a[1].x + 3 * b * b * d * a[2].x + f * a[
              3].x), Math.round(e * a[0].y + 3 * b * d * d * a[1].y + 3 * b * b * d * a[2].y + f * a[3].y))
          ...
          var c;
          return "string" == typeof a && (c = /^(\d+)(px|%)$/.exec(a)) ? "px" == c[2] ? parseInt(c[1], 10) : "%" == c[
              2] ? parseInt(c[1], 10) / 100 * b : void 0 : a
          ...
          return this.has3d && c ? " translate3d(" + a + "px," + b + "px, 0px) " : " translate(" + a + "px, " + b +
              "px) "
          ...
          var b;
          return "-webkit-" == this.vendor ? a ? (b = "-webkit-gradient(linear, left top, right top,", b +=
              "color-stop(0, rgba(0,0,0,0)),", b += "color-stop(0.3, rgba(0,0,0, 0.3)),", b +=
              "color-stop(0.5, rgba(0,0,0, 0.8))", b += ")") : (b =
              "-webkit-gradient(linear, left top, right top,", b += "color-stop(0, rgba(0,0,0,0)),", b +=
              "color-stop(0.2, rgba(0,0,0,0.5)),", b += "color-stop(0.2, rgba(0,0,0,0.6)),", b +=
              "color-stop(0.4, rgba(0,0,0,0.2)),", b += "color-stop(1, rgba(0,0,0,0))", b += ")") : (b = this.vendor +
              "linear-gradient(left, ", a ? (b += "rgba(0,0,0,0) 0%,", b += "rgba(0,0,0,0.3) 30%,", b +=
                  "rgba(0,0,0,0.8) 50%") : (b += "rgba(0,0,0,0) 0%,", b += "rgba(0,0,0,0.2) 20%,", b +=
                  "rgba(0,0,0,0.6) 20%,", b += "rgba(0,0,0,0.2) 40%,", b += "rgba(0,0,0,0) 100%"), b += ")"), b
      }, b.gradient = function (a, b, c, d, e) {
          var f, g = [];
          if ("-webkit-" == this.vendor) {
              for (f = 0; e > f; f++) g.push("color-stop(" + d[f][0] + ", " + d[f][1] + ")");
              a.css({
                  "background-image": "-webkit-gradient(linear, " + b.x + "% " + b.y + "%," + c.x + "% " + c.y +
                      "%, " + g.join(",") + " )"
              })
          }
          ...
          var f = a.data(this, d);
          return f ? f._bind.apply(f, e) : (b.oneTimeInit(), f = new c(this, d), a.data(this, d, f), f._init.apply(f,
              e))
          ...
          this.vendor || (this.has3d = this.css3dAvailable(), this.hasRotation = this.rotationAvailable(), this.vendor =
          ...
          if (b.width > a.boundWidth || b.height > a.boundHeight) {
              ...
              a.boundWidth / c > a.boundHeight && a.boundHeight * c <= a.boundWidth ? (b.width = Math.round(a.boundHeight *
                  c), b.height = a.boundHeight) : (b.width = a.boundWidth, b.height = Math.round(a.boundWidth / c))
          }
          return b
          ...
          if (b.animation) {
              ...
              for (var d = 0; d < b.animation._elements; d++) b.animation.from[d] = b.animation.current[d], b.animation
                  .to[d] = c.to[d] - b.animation.from[d]
          } else {
              ...
              b.animation = a.extend({
                  ...
                  _frame: function () {
                      for (var a = Math.min(this.duration, (new Date).getTime() - this._time), c = 0; c <
                          this._elements; c++) this.current[c] = this.easing(a, this.from[c], this.to[c],
                          this.duration);
                      e = !0, this.frame(this.current), a >= this.duration ? (this.stop(), this.completed &&
                          this.completed()) : window.requestAnimationFrame(function () {
          ...
          return /ipad/i.test(b) ? a = "ipad" : /iphone/i.test(b) ? a = "iphone" : /ipod/i.test(b) ? a = "ipod" :
              /kindle/i.test("iPod") && (a = "kindle"), a
      }, window.requestAnimationFrame || (window.requestAnimationFrame = window.webkitRequestAnimationFrame || window
          .mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (a) {
  ...
  b.eventPrefix = "", b.isTouchDevice = c, b.isInside = function (b, c) {
      ...
      return d._triggerVirtualEvent = function (a) {
          ...
          c = c || {}, c.type = this.eventName, c.target = b.target, c.toElement = b.toElement, c.currentTarget =
              b.currentTarget, c.delegateTarget = b.delegateTarget, c.pageX = c.pageX || b.pageX, c.pageY = c
              .pageY || b.pageY;
          var d = a.Event(b, c);
      ...
      a.event.special[c] = {
          ...
          remove: function (b) {
              var d = b.selector || "",
                  ...
                  f = a(this),
                  g = f.data(e);
              g && g.listeners > 0 && (g.listeners--, 0 === g.listeners && (g.instance._remove(), delete g
                  .instance))
          }
      }
  ...
  var d = b.Event("tap", {
          _init: function () {
              c ? (this.$el.on("touchstart", this._selector, a.proxy(this, "_touchstart")), this.$el.on(
                  "touchmove", this._selector, a.proxy(this, "_touchmove")), this.$el.on("touchend",
                  this._selector, a.proxy(this, "_touchend"))) : this.$el.on("click", this._selector, a.proxy(
                  this, "_trigger"))
          },
          _remove: function () {
              c ? (this.$el.off("touchstart", this._selector, this._touchstart), this.$el.off("touchmove",
                      this._selector, this._touchmove), this.$el.off("touchend", this._selector, this._touchend)) :
                  this.$el.off("click", this._selector, this._trigger)
          },
          _touchstart: function (b) {
              this._data.startEvent = b, this._data.initScrollTop = a(window).scrollTop(), this._data.initScrollLeft =
                  a(window).scrollLeft()
          },
          ...
          _touchend: function () {
              if (this._data.startEvent) {
                  ...
                  if (b.isInside(c, this._data.startEvent.currentTarget || this.el) && this._data.initScrollTop ==
                      d && this._data.initScrollLeft == e) {
                      var f = this,
      ...
      f = b.Event("vmouseover", {
          _init: function () {
              c ? this.$el.on("touchstart", this._selector, a.proxy(this, "_trigger")) : this.$el.on(
                  "mouseover", this._selector, a.proxy(this, "_trigger"))
          },
          _remove: function () {
              c ? this.$el.off("touchstart", this._selector, this._trigger) : this.$el.off("mouseover", this._selector,
                  this._trigger)
          }
      }),
      g = b.Event("vmouseout", {
          _init: function () {
              c ? this.$el.on("touchend", this._selector, a.proxy(this, "_trigger")) : this.$el.on("mouseout",
                  this._selector, a.proxy(this, "_trigger"))
          },
          _remove: function () {
              c ? this.$el.off("touchend", this._selector, this._trigger) : this.$el.off("mouseout", this._selector,
                  this._trigger)
          }
      }),
      h = b.Event("vmousedown", {
          _init: function () {
              c ? this.$el.on("touchstart", this._selector, a.proxy(this, "_trigger")) : this.$el.on(
                  "mousedown", this._selector, a.proxy(this, "_trigger"))
          },
          _remove: function () {
              c ? this.$el.off("touchstart", this._selector, this._trigger) : this.$el.off("mousedown", this._selector,
                  this._trigger)
          }
      }),
      i = b.Event("vmouseup", {
          _init: function () {
              c ? this.$el.on("touchend", this._selector, a.proxy(this, "_trigger")) : this.$el.on("mouseup",
                  this._selector, a.proxy(this, "_trigger"))
          },
          _remove: function () {
              c ? this.$el.off("touchend", this._selector, this._trigger) : this.$el.off("mouseup", this._selector,
                  this._trigger)
          }
      }),
      j = b.Event("vmousemove", {
          _init: function () {
              c ? this.$el.on("touchmove", this._selector, a.proxy(this, "_trigger")) : this.$el.on(
                  "mousemove", this._selector, a.proxy(this, "_trigger"))
          },
          _remove: function () {
              c ? this.$el.off("touchmove", this._selector, this._trigger) : this.$el.off("mousemove", this._selector,
                  this._trigger)
          }
      }),
      k = b.Event("swipe", {
          ...
          _vmousedown: function (c) {
              var d = this._data;
              d.firstEvent = b.eventPoint(c), d.currentEvent = d.firstEvent, d.prevEvent = d.firstEvent, a(
                  document).on("vmousemove", a.proxy(this, "_vmousemove")), a(document).on("vmouseup", a.proxy(
                  this, "_vmouseup"))
          },
          ...
          _vmouseup: function () {
              ...
              if (-.2 > e || e > .2) {
                  var f = {};
                  f.pageX = b.currentEvent.x, f.pageY = b.currentEvent.y, f.speed = e, this._triggerVirtualEvent(
                      this.Event(b.firstEvent, f))
              }
      ...
      l = b.Event("pinch", {
          ...
          _touchstart: function (c) {
              var d = this._data;
              d.firstEvent = b.eventPoint(c), d.pinch = null, a(document).on("touchmove", a.proxy(this,
                  "_touchmove")), a(document).on("touchend", a.proxy(this, "_touchend"))
          },
          _touchmove: function (a) {
              ...
              if (2 == c.length) {
                  ...
                  d.pinch || (d.pinch = {
                          ...
                          prevDistance: i,
                          prevMidpoint: h
                      }), e.pageX = h.x, e.pageY = h.y, e.dx = h.x - d.pinch.prevMidpoint.x, e.dy = h.y - d.pinch
                      .prevMidpoint.y, e.factor = i / d.pinch.initDistance, e.dfactor = i / d.pinch.prevDistance,
                      d.pinch.prevDistance = i, d.pinch.prevMidpoint = h, this._triggerVirtualEvent(this.Event(
                          d.firstEvent, e))
              }
          },
          _touchend: function () {
  ...
  var m = {
      ...
      n = b.UIComponent(function (d) {
          ...
          if (d.cornerPosition = b.point2D(parseInt(h[0], 10), parseInt(h[1], 10)), e.options = d, e.dynamicMode = !
              1, e.turningPage = !1, e.watchSizeChange = !0, e.pageObjs = {}, e.pageBlocks = {}, e.pages = {}, e.pageWrap = {},
              e.blocks = {}, e.pageMv = [], e.front = [], e.scroll = {
                  left: 0,
                  top: 0
              }, e.margin = [0, 0, 0, 0], e.pageMargin = [0, 0, 0, 0], e.zoom = 1, e.totalPages = d.pages || 0, d
              .when && (d.delegate = d.when), d.delegate)
              for (var i in d.delegate) b.has(i, d.delegate) && ("tap" == i || "doubletap" == i ? this.$el.on(i,
                  ".page", d.delegate[i]) : this.$el.on(i, d.delegate[i]));
          this.$el.css({
                  position: "relative",
                  width: d.width,
                  height: d.height
              }), c ? this.$el.addClass("touch-device") : this.$el.addClass("no-touch-device"), this.display(d.display),
              "" !== d.direction && this.direction(d.direction);
          for (var j = 0; j < f.length; j++) a(f[j]).is(d.ignoreElements) || this.addPage(f[j], ++g);
          return d.pages = e.totalPages, e.dynamicMode = 0 === g, d.swipe && this.$el.on("swipe", a.proxy(this,
                  "_eventSwipe")), this.$el.parent().on("start", a.proxy(this, "_eventStart")), this.$el.on(
                  "vmousedown", a.proxy(this, "_eventPress")).on("vmouseover", a.proxy(this, "_eventHover")).on(
                  "vmouseout", a.proxy(this, "_eventNoHover")), this._resizeObserver(), "number" != typeof d.page ||
              isNaN(d.page) || d.page < 1 || d.page > e.totalPages ? this.page(1) : this.page(d.page), d.animatedAutoCenter &&
              this.$el.css(b.addCssWithPrefix({
  ...
  var o = b.A90,
      ...
      q = b.UIComponent(function (a, b) {
          return a = a || {}, a.disabled = !1, a.hover = !1, a.turn = b, a.turnData = b._data, a.effect = this.$el
              .hasClass("hard") || this.$el.hasClass("cover") ? "hard" : "sheet", this.$el.data("f", a), this._addPageWrapper(),
              a.turnData.disabled && this.disable(), this.$el
      });
  q.prototype._cornerAllowed = function () {
      ...
      switch (a.effect) {
          ...
          case "sheet":
              if (d.display == b.DISPLAY_SINGLE) return 1 == c ? b.corners.forward : c == d.totalPages ? b.corners
                  .backward : "tapping" == a.status ? b.corners.all : b.corners.forward;
              if (d.display == b.DISPLAY_DOUBLE) return d.options.showDoublePage ? b.corners[e ? "backward" :
                  "forward"] : b.corners[e ? "forward" : "backward"]
      }
      ...
      switch (g.effect) {
          case "hard":
              ...
              break;
          case "sheet":
              f.y < k ? f.corner += "t" : f.y >= e - k && (f.corner += "b"), f.x <= k ? f.corner += "l" : f.x >=
                  d - k && (f.corner += "r")
      }
      ...
      switch (c.effect) {
          case "hard":
              d = b.layerCSS(0, 0, 2).css, d[b.vendor + "transform-style"] = "preserve-3d", d[b.vendor +
                      "backface-visibility"] = "hidden", f.css(d).appendTo(e).prepend(this.$el), g.css(b.layerCSS(
                      0, 0, 0).css).appendTo(f), h.css(b.layerCSS(0, 0, 0)), c.ipage = f, c.igradient = g, c.ogradient =
                  h;
              break;
          case "sheet":
              var i = a("<div />", {
              ...
              d = b.layerCSS(0, 0, 0).css, i.css(d), f.css(a.extend({
                      ...
                      position: "absolute",
                      "z-index": 2
                  }), g.appendTo(f), f.appendTo(i).prepend(this.$el), h.appendTo(e), i.appendTo(e), c.clip = i, c
                  .ipage = f, c.igradient = g, c.ogradient = h
      }
      this.resize()
      ...
      c ? d = e : f.pages[e.over] && (d = f.pages[e.over].data("f")), d && (d.clip && d.clip.transform(g), d.ipage
          .transform(g).css({
              top: 0,
              left: 0,
              right: "auto",
      ...
      if (d && e) {
          ...
          if (!f || !d.point || d.point.corner != a.corner) {
              if (i.corner = g, this._trigger("start", d.page, i.tpage ? null : a.corner) == b.EVENT_PREVENTED)
                  return !1;
              ...
              if ("hard" == d.effect && "turning" == i.status)
                  for (var j = 0; j < i.front.length; j++)
                      if (!i.pages[i.front[j]].hasClass("hard")) {
                          ...
                          break
                      } f || (i.front.push(i.display == b.DISPLAY_SINGLE ? 0 : d.next), i.pageMv.push(d.page)), d
                  .startPoint = d.startPoint || b.point2D(a.x, a.y), d.visible = !0, this._bringClipToFront(!0),
                  n.prototype.update.call(h), i.options.blocks && n.prototype._fetchBlocks.call(h, Math.max(i.options
                      .pages + 1, n.prototype.view.call(h, d.next)[0]), "hover")
          }
      ...
      switch (a.effect) {
          case "hard":
              ...
              a.ogradient.remove(), a.igradient.remove(), a.ipage.transform(d), e && e.data("f").ipage.transform(
                  d);
              break;
          case "sheet":
      ...
      return a.visible && 0 === c.front.length && n.prototype._removeFromDOM.call(a.turn), a.status = "", a.visible = !
          1, delete a.point, delete a.dpoint, delete a.startPoint, this.$el
      ...
      if (c.dpoint) {
          ...
          if (a) {
              ...
              i[3] = g ? this._startPoint(i[0].corner, b.point2D(c.peel.x, c.peel.y)) : this._startPoint(i[0].corner,
                  b.point2D(0, 1));
              var j = i[0].y - i[3].y;
              j = "tr" == i[0].corner || "tl" == i[0].corner ? Math.min(0, j) / 2 : Math.max(0, j) / 2, i[1] = b.point2D(
                  i[0].x, i[0].y + j), i[2] = b.point2D(i[3].x, i[3].y - j), this._animate(!1), this._animate({
                  from: 0,
                  to: 1,
                  frame: function (a) {
      ...
      if (has3d = b.css3dAvailable(), h.display == b.DISPLAY_SINGLE && -1 == a.inArray(c, b.corners.forward)) {
          ...
          e = k.dpoint ? k.dpoint.corner : c, d = b.peelingPoint(h.direction == b.DIRECTION_LTR ? e.replace("l",
              "r") : e.replace("r", "l")), f = j, h.pageWrap[g.page - 1].show().css({
              zIndex: m + 1
          }), i[0] = k.dpoint ? b.point2D(k.dpoint.x, k.dpoint.y) : this._endPoint(d.corner), i[1] = i[0], i[
              2] = this._startPoint(d.corner, b.point2D(0, 20)), i[3] = l ? this._startPoint(d.corner, b.point2D(
              l.x, l.y)) : this._startPoint(d.corner)
      } else {
          var o = "r" == c || "l" == c ? 0 : h.options.elevation,
              p = b.transformUnit(o, this.$el.height());
          e = g.dpoint ? g.dpoint.corner : c, d = b.peelingPoint(e || this._cornerAllowed()[0]), i[0] = g.dpoint ||
              this._startPoint(d.corner), i[1] = g.dpoint ? i[0] : this._startPoint(d.corner, b.point2D(0, p)), (
                  i[0].x < 0 || i[0].x > this.$el.width()) && (p = 0), i[2] = this._endPoint(d.corner, b.point2D(
                  0, p)), i[3] = this._endPoint(d.corner)
      }
      f.flip("_animate", !1), f.flip("_showFoldedPage", i[0]) ? (g.turnData.options.autoCenter && n.prototype.center
          .call(g.turn, g.next), f.flip("_animate", {
              from: 0,
              to: 1,
      ...
      if (e.holdingPoint) {
          ...
          if (c = g.direction == b.DIRECTION_LTR ? h ? e.holdingPoint.x > d.width() / 2 ? "r" : "l" : g.options.showDoublePage ?
              0 === e.page % 2 ? "r" : "l" : 0 === e.page % 2 ? "l" : "r" : h ? e.holdingPoint.x > d.width() / 2 ?
              "l" : "r" : g.options.showDoublePage ? 0 === e.page % 2 ? "l" : "r" : 0 === e.page % 2 ? "r" : "l",
              n.prototype.stop.call(f), this._animate(!1), e.status = "holding", ~a.inArray(c, i)) {
              g.tmpListeners || (g.tmpListeners = {}, g.tmpListeners.tap = b.getListeners(f.$el, "tap", !0), g.tmpListeners
                  .doubleTap = b.getListeners(f.$el, "doubleTap", !0));
              var j = b.peelingPoint(c, e.holdingPoint.x, e.holdingPoint.y);
              h ? this._detectSinglePage(j, j, !0) && (e.corner = b.peelingPoint(c, e.holdingPoint.x, e.holdingPoint
                  .y)) : this._showFoldedPage(j, !0) && (e.corner = b.peelingPoint(c, e.holdingPoint.x, e.holdingPoint
                  .y))
          }
      }
      ...
      if (!d.corner && !d.disabled && !this.isTurning()) {
          ...
          if (!(f.options.hover || d.peel && d.peel.corner == g.corner)) return f.status = "", d.status = "",
              void 0;
          if (f.display == b.DISPLAY_SINGLE && f.pages[d.next] && d.effect != f.pages[d.next].data("f").effect &&
              f.pageObjs[d.next].hasClass("cover") && ~a.inArray(g.corner, b.corners.forward)) return f.status =
              "", d.status = "", void 0;
          if (d.corner = g, d.startPoint = null, has3d = b.css3dAvailable(), d.corner && this._foldingPage())
              return n.prototype.update.call(e), !0;
          d.corner = null;
          var h = b.eventPoint(c),
              i = f.pageWrap[d.page].offset();
          h.x -= i.left, h.y -= i.top, f.options.smartFlip && ~a.inArray(d.page, n.prototype.view.call(e)) && h.x >
              0 && h.y > 0 && h.x < this.$el.width() && h.y < this.$el.height() && (d.holdingPoint = h, d.startPoint =
                  h, d.holding = setTimeout(a.proxy(this._showWhenHolding, this), 100))
      }
  }, q.prototype._pageMove = function (a) {
      var c, d, e, f, g = this.$el.data("f");
      if (!g.disabled) {
          if (a.preventDefault(), g.corner) return e = g.turn, f = g.turnData, d = f.pageWrap[g.page].offset(), g
              .status = "move", c = b.eventPoint(a), c.x -= d.left, c.y -= d.top, c.corner = g.corner.corner,
              f.display == b.DISPLAY_SINGLE ? this._detectSinglePage(c, g.corner) : this._showFoldedPage(c),
              g.holdingPoint && b.cleanSelection(), !0;
          if (!this.animation)
              ...
              } else "peel" == g.status && (g.peel && g.peel.corner == g.dpoint.corner || (g.status = "", this.hideFoldedPage(
                  !0)));
          return !1
      }
      ...
      if (!c.disabled && d && "turning" != f.status && "swiped" != f.status) {
          ...
          if (f.display == b.DISPLAY_SINGLE)
              if (1 == h) "tapping" == c.status || g.x < i / 2 ? n.prototype._turnPage.call(e, c.next, g.corner) :
                  this.hideFoldedPage(!0);
              else if (~a.inArray(g.corner, b.corners.forward)) "tapping" == c.status || g.x < i / 2 ? n.prototype
              ._turnPage.call(e, c.next, g.corner) : this.hideFoldedPage(!0);
          else {
              var j = f.pages[c.page - 1];
              g = j.data("f").point, "tapping" == c.status || g.x > .1 * i ? (n.prototype._turnPage.call(e, c.page -
                  1, g ? g.corner : null), f.status = "turning") : j.flip("turnPage", g.corner)
          } else f.display == b.DISPLAY_DOUBLE && ("tapping" == c.status || g.x < 0 || g.x > i ? n.prototype._turnPage
              .call(e, c.next, g.corner) : this.hideFoldedPage(!0))
      }
      c.holdingPoint && (clearInterval(c.holding), delete c.holdingPoint, delete c.holding), c.status = "", c.corner =
          null
      ...
      if (h.pageWrap[f.page].offset(), -1 == a.inArray(d.corner, b.corners.forward)) {
          var i, j = h.pages[f.page - 1],
              k = j.data("f");
          if (c.corner = h.direction == b.DIRECTION_LTR ? c.corner.replace("l", "r") : c.corner.replace("r", "l"),
              k.visible) return i = j.flip("_showFoldedPage", c, !1), h.corner = d.corner, i;
          var l = j.flip("_endPoint", c.corner);
          return k.point = b.peelingPoint(c.corner, l.x, l.y), n.prototype.stop.call(g), i = j.flip(
              "_showFoldedPage", c, !0), h.corner = d.corner, i
      }
      ...
      if (c.corner) {
          if (-1 == a.inArray(c.corner, b.corners.all)) throw b.turnError("Corner " + c.corner +
              " is not permitted");
      ...
      var d = this.$el.data("f"),
          e = d.turn,
          f = d.turnData;
      if ((c || !d.peel || d.peel.corner != d.dpoint.corner) && (f.front.splice(f.front.indexOf(parseInt(d.next,
              10)), 1), f.pageMv.splice(f.pageMv.indexOf(parseInt(d.page, 10)), 1), this.$el.css({
              visibility: "hidden"
          }), this.hide(), 0 === f.front.length && (f.corner = null)), c) {
          var g = f.tpage || f.page;
          g == d.next || g == d.page ? (delete f.tpage, n.prototype._fitPage.call(e, g || d.next)) : f.pageWrap[d
              .page].hide()
      ...
      if (this._animation) {
          ...
          for (var c = 0; c < this.animation._elements; c++) this.animation.from[c] = this._animation.current[c],
          ...
          this.animation = a.extend({
              ...
              _frame: function () {
                  for (var a = Math.min(this.duration, (new Date).getTime() - this._time), b = 0; b <
                      this._elements; b++) this.current[b] = this.easing(a, this.from[b], this.to[b],
                      this.duration);
                  e = !0, this.frame(1 == this._elements ? this.current[0] : this.current), a >= this
                      .duration ? (this.stop(), this.complete && this.complete()) : window.requestAnimationFrame(
                          function () {
      ...
      var a = this.$el.data("f");
      a.clip && (this._animate(!1), a.clip.detach(), delete a.clip, delete a.igradient, delete a.ogradient,
          delete a.ipage, delete a.turnData, delete a.turn), this._destroy()
      ...
      var g, h = "",
          i = !1,
          j = f.totalPages + 1;
      if (e = e || {}, (g = /\bpage\-([0-9]+|last|next\-to\-last)\b/.exec(a(c).attr("class"))) && (d = "last" ==
              g[1] ? f.totalPages : "next-to-last" == g[1] ? f.totalPages - 1 : parseInt(g[1], 10)), d) {
          if (d == j) i = !0;
          else if (d > j) throw b.error('Page "' + d + '" cannot be inserted')
      } else d = j, i = !0;
      return d >= 1 && j >= d && (d in f.pageObjs && this._movePages(d, 1), i && (f.totalPages = j), f.pageObjs[d] =
          a(c), f.pageObjs[d].hasClass("cover") || (h += "page "), h += "page-" + d + " ", h += f.display ==
          b.DISPLAY_DOUBLE ? d % 2 ? "page-odd" : "page-even" : "page-odd", f.pageObjs[d].css({
              "float": "left"
          }).addClass(h), f.pageObjs[d].data({
              f: e
          }), !b.hasHardPage() && f.pageObjs[d].hasClass("hard") && f.pageObjs[d].removeClass("hard"), this._addPage(
              d), f.done && this._removeFromDOM()), this.$el
      ...
      var c = this._data,
          ...
          f = this.$el.height(),
          g = c.pageObjs[a];
      if (c.display == b.DISPLAY_SINGLE) d.width = e, d.height = f, d.top = 0, d.left = 0, d.right = "auto", g.hasClass(
          "page") ? (d.top = c.pageMargin[0], d.width -= c.pageMargin[1], d.height -= c.pageMargin[0] + c.pageMargin[
          2]) : 2 == a && g.hasClass("cover") && (d.left = -e);
      else if (c.display == b.DISPLAY_DOUBLE) {
          var h = Math.floor(e / 2),
              i = f,
              j = a % 2;
          d.top = 0, g.hasClass("own-size") ? (d.width = c.pageObjs[a].width(), d.height = c.pageObjs[a].height()) :
              (d.width = h, d.height = i), g.hasClass("page") && (d.top = c.pageMargin[0], d.width -= j ? c.pageMargin[
                  1] : c.pageMargin[3], d.height -= c.pageMargin[0] + c.pageMargin[2]), c.direction != b.DIRECTION_LTR ||
              c.options.showDoublePage ? (d[j ? "left" : "right"] = h - d.width, d[j ? "right" : "left"] = "auto") :
              (d[j ? "right" : "left"] = h - d.width, d[j ? "left" : "right"] = "auto")
      }
      return d
      ...
      if (!c.pages[a]) {
          var d, e = c.display == b.DISPLAY_SINGLE,
              f = a % 2;
          d = e ? a + 1 : c.options.showDoublePage && !e ? f ? a - 1 : a + 1 : f ? a + 1 : a - 1, c.options.blocks >
              0 && (c.pageBlocks[a] || (c.pageBlocks[a] = {
                  first: 0,
                  last: 0,
      ...
      var a, b = this._data;
      if (b.totalPages > 0)
          for (b.range = this.range(), a = b.range[0]; a <= b.range[1]; a++) b.pageObjs[a] && !b.pageWrap[a] &&
              this._addPage(a)
      ...
      if (g.options.blocks > 0) {
          ...
          g.display == b.DISPLAY_DOUBLE && g.options.showDoublePage && (i += 1), i > h && (h = i, g.totalPages =
              h)
      }
      return a = a || g.tpage || g.page || 1, f = this._view(a), f[1] = f[1] || f[0], f[0] >= 1 && f[1] <= h ? (c =
          Math.floor((g.options.cacheSize - 2) / 2), h - f[1] > f[0] ? (d = Math.min(f[0] - 1, c), e = 2 * c -
              d) : (e = Math.min(h - f[1], c), d = 2 * c - e)) : (d = g.options.cacheSize - 1, e = g.options.cacheSize -
          1), [Math.max(1, f[0] - d), Math.min(h, f[1] + e)]
  }, n.prototype._pageNeeded = function (a) {
      if (0 === a) return !0;
      var b = this._data,
          c = b.range || this.range();
      return b.pageObjs[a].hasClass("cover") || ~b.pageMv.indexOf(a) || ~b.front.indexOf(a) || a >= c[0] && a <=
          c[1]
  }, n.prototype._removeFromDOM = function () {
      if (!this.isAnimating()) {
          var a = this._data;
          for (var c in a.pageWrap) b.has(c, a.pageWrap) && (c = parseInt(c, 10), this._pageNeeded(c) || this._removePageFromDOM(
              c))
      }
      ...
      if (d.pages[a] && (d.pages[a].flip("_bringClipToFront", !1), d.pages[a].flip("destroy"), d.pages[a].detach(),
              delete d.pages[a]), f[a] && f[a].detach(), d.pageWrap[a] && (d.pageWrap[a].detach(), delete d.pageWrap[
              a]), d.dynamicMode || c) {
          if (e = d.pageBlocks[a]) {
              for (var h = e.last || e.first, i = e.first; h >= i; i++) d.blocks[i] && (d.blocks[i].start ? g[d.blocks[
                  i].start] || g[d.blocks[i].end] || delete d.blocks[i] : delete d.blocks[i]);
      ...
      if ("*" == a) {
          ...
          this._movePages(a, -1), c.totalPages = c.totalPages - 1, c.page > c.totalPages ? (c.page = null, this._fitPage(
              c.totalPages)) : (this._makeRange(), this.update())
      }
      return this
      ...
      var d, e = this,
          ...
          h = function (a) {
              ...
              f.pageObjs[a] && (f.pageObjs[b] = f.pageObjs[a].removeClass("page-" + a + " page-odd page-even").addClass(
                  "page-" + b + h)), f.pageWrap[a] && (f.pageWrap[b] = f.pageObjs[b].hasClass("fixed") ? f.pageWrap[
                      a].attr("page", b) : f.pageWrap[a].css(e._pageSize(b, !0)).attr("page", b), f.pages[a] &&
                  (f.pages[b] = f.pages[a], f.pages[b].data("f").page = b, f.pages[b].data("f").next = g ? b +
                      1 : f.options.showDoublePage ? d ? b - 1 : b + 1 : d ? b + 1 : b - 1), c && (delete f.pages[
                      a], delete f.pageObjs[a], delete f.pageWrap[a]))
          };
      if (c > 0)
      ...
      var c = this._data;
      return a = a || c.page, c.display == b.DISPLAY_DOUBLE ? c.options.showDoublePage ? a % 2 ? [a, a + 1] : [a -
              1, a] : a % 2 ? [a - 1, a] : [a, a + 1] : 0 === a % 2 && c.pages[a] && c.pages[a].hasClass("cover") ?
          [a, a + 1] : [a]
  }, n.prototype.view = function (a, b) {
      var c = this._data,
          d = this._view(a),
          e = [];
      return b ? (d[0] > 0 && e.push(d[0]), d[1] <= c.totalPages && e.push(d[1])) : (d[0] > 0 ? e.push(d[0]) : e.push(
          0), d[1] && (d[1] <= c.totalPages ? e.push(d[1]) : e.push(0))), e
      ...
      return c.display == b.DISPLAY_DOUBLE ? c.options.showDoublePage ? 2 * a - 1 + e : 2 * a - 2 + e : a + c.options
          .pages
      ...
      if (d.options.blocks) {
          ...
          if (a > d.options.pages) {
              if (c) {
                  for (var e, f = this.range(), g = this.view(d.page, !0), h = 0, i = 0, j = 0, k = 0, l = 0, m =
                          f[0]; m <= f[1]; m++) d.pageBlocks[m] && (h || (h = d.pageBlocks[m].first, j = m), d.pageBlocks[
                      m].last && (i = d.pageBlocks[m].last, k = m), d.pageBlocks[m].first && (l = m));
                  0 === i && l && (i = d.pageBlocks[l].first, k = l), d.display == b.DISPLAY_DOUBLE ? d.options.showDoublePage ?
                      1 === a % 2 && (a > g[g.length - 1] ? (0 === k % 2 && (k -= 1), e = i + (a - k) / 2) : a <
                          g[0] ? (0 === j % 2 && (j -= 1), e = h - (j - a) / 2) : e = (a + 1) / 2) : 0 === a % 2 &&
                      (a > f[1] ? (1 == k % 2 && (k -= 1), e = i + (a - k + 2) / 2) : a < f[0] ? (1 == j % 2 && (
                          j -= 1), e = h - (j - a + 2) / 2) : e = (a + 2) / 2) : e = a > f[1] ? d.pageBlocks[f[1]]
                      .last + (a - f[1]) : a < f[0] ? d.pageBlocks[f[0]].first - (f[0] - a) : a - d.options.pages
              } else d.display == b.DISPLAY_DOUBLE ? d.options.showDoublePage ? 1 == a % 2 && (e = Math.ceil((a -
                      d.options.pages + 1) / 2)) : 0 === a % 2 && (e = Math.ceil((a - d.options.pages + 2) / 2)) :
                  e = a - d.options.pages;
      ...
      if (c.options.blocks && c.pageBlocks[a]) {
          ...
          if (d.status == b.fragStatus.assigned) d.first || (d.first = this.getPageBlock(a, !0)), d.status = b.fragStatus
              .requested, this._pushBlocks(d.first, a, c.page);
          else if (d.status == b.fragStatus.waiting) a > e[0] && this._cleanPages(a + 1, this.range()[1]), this._pushBlocks(
              d.last, a, c.page);
              ...
              if (a > e[0] && (this._cleanPages(a + 1, this.range()[1]), d.nextPageTmp)) {
                  var f = c.pageObjs[a + 1],
                      g = c.pageBlocks[a + 1],
                      h = f.data("f");
                  g.status = b.fragStatus.waiting, g.first = d.last, g.last = d.last, g.bp = d.lbp, h.flowTo ? f.find(
                          h.flowTo).html(d.nextPageTmp.html()) : f.html(d.nextPageTmp.html()), delete d.nextPageTmp,
      ...
      var c = this._data;
      a > 0 && a <= c.options.blocks && (b = b.replace(/\s+/g, " "), c.blocks[a] ? (c.blocks[a].html = b, this._pushBlocks(
          a)) : c.blocks[a] = {
          html: b,
          queue: []
      })
      ...
      if (f && g) {
          ...
          if (d < h.first || d > h.last) {
              ...
              if (f.start = c, d < h.first) {
                  h.first = d;
                  var p = j.children();
                  p.length > 0 ? (h.bp = null, o.insertBefore(p[0]), this._cleanPages(n[0], c - 1)) : o.appendTo(
                      j)
              } else o.appendTo(j);
          ...
          var q, r, s = c + 1,
              t = e.pageBlocks[s],
              u = e.pageObjs[s];
          u && (q = u.data("f"), r = q.flowTo ? u.find(q.flowTo) : u, t.first == h.last && s < l[0] && (restore(j[
              0], r[0]), q.first = 0, q.last = 0, q.status = b.fragStatus.assigned));
          ...
          if (v)
              if (h.loading && (h.loading = !1, this.$el.trigger("endPageLoading", c)), s < l[0] || c >= l[0])
                  if (h.status = b.fragStatus.full, u) {
                      ...
                      h.last = v.path[0] + h.first, t.first = h.last, t.last = t.first + r.children("div").length -
                          1;
                      for (var w = t.first; w <= t.last; w++) e.blocks[w] && (w == t.first && w == h.last ? e.blocks[
                          w].end = s : (e.blocks[w].start = s, e.blocks[w].end = s));
                      t.bp = v, this._flowContent(s, t.last)
                  } else breakPage(v, j[0], null);
          else h.status = b.fragStatus.nsplit, h.nextPageTmp = a("<div />"), h.lbp = v, breakPage(v, j[0], h.nextPageTmp[
              0]);
              ...
              if (!x.bp && (x.first > 2 || m[0] == e.options.pages + 1)) this._pushBlocks(x.first - 1, m[0], k);
                  ...
                  var y = m[m.length - 1];
                  e.pageBlocks[y].last ? this._pushBlocks(e.pageBlocks[y].last + 1, y, k) : this._pushBlocks(e.pageBlocks[
                      m[0]].last + 1, m[0], k)
              }
      ...
      for (var b = this._data, c = this.view(a, !0), d = 0; d < c.length; d++) c[d] >= a && !b.pageBlocks[c[d]].loading &&
          (b.pageBlocks[c[d]].loading = !0, this.$el.trigger("startPageLoading", [c[d]]))
  }, n.prototype._cleanPages = function (a, b) {
      for (var c, d, e, f = this._data, g = a; b >= g; g++)
          if ((d = f.pageBlocks[g]) && d.first) {
              e = d.last || d.first;
              for (var h = d.first; e >= h; h++) f.blocks[h] && (h == d.first && f.pageBlocks[g - 1] && h == f.pageBlocks[
                  g - 1].last || (f.blocks[h].page = 0, f.blocks[h].start && (f.blocks[h].start = 0, f.blocks[
                  h].end = 0)));
              d.first = 0, d.status = fragStatus.assigned, d.last = 0, d.bp = null, c = f.pageObjs[g].data("f"),
                  c.flowTo ? f.pageObjs[g].find(c.flowTo).html("") : f.pageObjs[g].html("")
          }
          ...
          for (var t in d.pageObjs)
              if (b.has(t, d.pageObjs))
                  if (t = parseInt(t, 10), a > t) this._removePageFromDOM(t);
                      ...
                      if (i = t + l, g = d.pageObjs[t].data("f"), h = i % 2, d.pageObjs[t].removeClass(
                              "even odd p" + t).addClass((h ? "odd" : "even") + " p" + i), d.pageWrap[t].attr(
                              "page", i), g = d.pageObjs[t].data("f"), g.page = i, ~(f = j.indexOf(t)) && (d.front[
                              f] = i), ~(f = k.indexOf(t)) && (d.pageMv[f] = i), d.z.pageV[t] && (m[i] = !0), d.z
                          .pageZ[t] && (n[i] = d.z.pageZ[t]), g.next += l, g.over && (g.over += l), d.pageBlocks[
                              t]) {
                      ...
                      o[i] = d.pageObjs[t], p[i] = d.pages[t], q[i] = d.pageWrap[t], q[i].css(this._pageSize(i, !
                          0))
                  } d.pageObjs = o, d.pages = p, d.pageWrap = q, d.pageBlocks = r, d.pageWrap = q, d.z.pageV = m,
              d.z.pageZ = n, d.range = this.range(c), d.page = d.page - a + c, d.tpage && (d.tpage = d.tpage - a +
                  c, d.page = d.tpage), this._missing(c), this.update(), d.options.autoCenter && this.center(),
      ...
      if (b.options.blocks && this.$el.is(":visible")) {
          ...
          if (k) {
              ...
              var m = k.start;
              this._cleanPages(e[0], c - 1), this._cleanPages(c + 1, e[1]), k.start = m, this._flowContent(c, b.pageBlocks[
                  c].last)
          }
          return this.$el
      }
      ...
      var d = this._data,
          e = this.view(c);
      d.display == b.DISPLAY_SINGLE && d.pages[c] && d.pages[c].hasClass("cover") && -1 != a.inArray(c + 1, e) &&
          (c += 1), d.range = this.range(c), this._missing(), d.pageObjs[c] && (-1 != a.inArray(1, e) ? this.$el.addClass(
                  "first-page") : this.$el.removeClass("first-page"), ~a.inArray(d.totalPages, e) ? this.$el.addClass(
                  "last-page") : this.$el.removeClass("last-page"), d.status = "", d.peel = null, d.page = c, d.display !=
              b.DISPLAY_SINGLE && this.stop(), this._removeFromDOM(), this._makeRange(), this._updateShadow(),
              this._cloneView(!1), this.$el.trigger("turned", [c, e]), this.update(), e[0] > d.options.pages ?
              this._fetchBlocks(e[0], "fixed") : e[1] > d.options.pages && this._fetchBlocks(e[1], "fixed"), d.options
              .autoCenter && this.center())
      ...
      var l = h.options.turnCorners.split(","),
          m = h.pages[e].data("f"),
          n = m.dpoint;
      if (m.next, d || (d = "hard" == m.effect ? h.direction == b.DIRECTION_LTR ? c > e ? "r" : "l" : c > e ? "l" :
              "r" : h.direction == b.DIRECTION_LTR ? a.trim(l[c > e ? 1 : 0]) : a.trim(l[c > e ? 0 : 1])), k ? g >
          e && -1 == h.pageMv.indexOf(e) ? this.stop() : e > g && -1 == h.pageMv.indexOf(g) && this.stop() : h.display ==
          b.DISPLAY_DOUBLE && Math.abs((h.tpage || h.page) - c) > 2 && this.stop(), h.page != c) {
          if (f = h.page, this._trigger("turning", c, j, d) == b.EVENT_PREVENTED) return ~a.inArray(e, h.pageMv) &&
              h.pages[e].flip("hideFoldedPage", !0), !1;
          ~a.inArray(1, j) ? (this.$el.addClass("first-page"), this.$el.trigger("first")) : this.$el.removeClass(
              "first-page"), ~a.inArray(h.totalPages, j) ? (this.$el.addClass("last-page"), this.$el.trigger(
              "last")) : this.$el.removeClass("last-page")
      }
      return h.status = "turning", h.range = this.range(c), this._missing(c), h.pageObjs[c] && (this._cloneView(!
              1), h.tpage = g, this._makeRange(), m.dpoint = m.next != g ? null : n, m.next = g, f = h.page,
          -1 == h.pageMv.indexOf(g) ? h.pages[e].flip("turnPage", d) : (h.options.autoCenter && this.center(g),
              h.status = "", h.pages[g].flip("hideFoldedPage", !0)), f == h.page && (h.page = c), this.update()
      ), !0
      ...
      if (!c.noCenter) {
          if (c.display == b.DISPLAY_DOUBLE) {
              ...
              c.direction == b.DIRECTION_LTR ? f[0] ? f[1] || (e += d.width / 4) : e -= d.width / 4 : f[0] ? f[1] ||
                  (e -= d.width / 4) : e += d.width / 4
          }
          this.$el.css({
              marginLeft: e
          })
      ...
      return this._trigger("destroy") != b.EVENT_PREVENTED && (c.watchSizeChange = !1, c.destroying = !0, this.$el
          .undelegate(), this.$el.parent().off("start", this._eventPress), c.options.viewer.off("vmousemove",
              this._eventMove), a(document).off("vmouseup", this._eventRelease), this.removePage("*"), c.zoomer &&
          c.zoomer.remove(), c.shadow && c.shadow.remove(), this._destroy()), this.$el
      ...
      return a == b.DISPLAY_SINGLE ? a : a == b.DISPLAY_DOUBLE ? a : "single" == a ? b.DISPLAY_SINGLE : "double" ==
          a ? b.DISPLAY_DOUBLE : void 0
      ...
      for (d in e.pages) b.has(d, e.pages) && e.pages[d].flip("disable", e.disabled ? !0 : -1 == a.inArray(
          parseInt(d, 10), f));
      return this.$el
  }, n.prototype._size = function (a, b) {
      var c = this._defaultSize();
      return c.width = c.width * a, c.height = c.height * a, b && this._halfWidth() && (c.width = Math.floor(c.width /
          2)), c
  }, n.prototype.peel = function (c, d, e, f) {
      var g = this._data;
      if (c) {
          if (1 == this.zoom())
              if (f = void 0 !== f ? f : !0, g.display == b.DISPLAY_SINGLE) g.peel = b.peelingPoint(c, d, e), g.pages[
                  g.page].flip("peel", b.peelingPoint(c, d, e), f);
              else {
                  var h = this.view(),
      ...
      if (b && b.watchSizeChange) {
          var c = b.options.viewer,
              d = 10;
          (b.viewerWidth != c.width() || b.viewerHeight != c.height()) && (b.viewerWidth = c.width(), b.viewerHeight =
              c.height(), this._resize()), b.monitorTimer = setTimeout(a.proxy(this._resizeObserver, this), d)
      }
      ...
      (a = d.options.margin) ? (c = e.exec(a)) && (d.margin[0] = b.transformUnit(c[1], d.viewerHeight), d.margin[
          1] = c[2] ? b.transformUnit(c[2], d.viewerWidth) : d.margin[0], d.margin[2] = c[3] ? b.transformUnit(
          c[3], d.viewerHeight) : d.margin[0], d.margin[3] = c[4] ? b.transformUnit(c[4], d.viewerWidth) : d.margin[
          1]) : d.margin = [0, 0, 0, 0], (a = d.options.pageMargin) ? (c = e.exec(a)) && (d.pageMargin[0] = b.transformUnit(
          c[1], d.viewerHeight), d.pageMargin[1] = c[2] ? b.transformUnit(c[2], d.viewerWidth) : d.pageMargin[
          0], d.pageMargin[2] = c[3] ? b.transformUnit(c[3], d.viewerHeight) : d.pageMargin[0], d.pageMargin[
          3] = c[4] ? b.transformUnit(c[4], d.viewerWidth) : d.pageMargin[1]) : d.pageMargin = [0, 0, 0, 0]
      ...
      if (e.options.responsive) {
          ...
          if (1 == e.zoom) {
              ...
              var g = e.slider;
              if (this._calculateMargin(), e.slider = null, d = this._defaultSize(), this.display(d.display, !1),
                  e.slider = g, d.display != e.display && (d = this._defaultSize(e.display)), this.size(d.width *
                      e.zoom, d.height * e.zoom), this.update(), e.zoomer)
      ...
      if (this.isAnimating() && 0 !== c.pageMv[0]) {
          ...
          if (j == b.DISPLAY_SINGLE)
              for (d = 0; h > d; d++) nextPage = c.pages[c.pageMv[d]].data("f").next, g.pageV[c.pageMv[d]] = !0,
                  g.pageZ[c.pageMv[d]] = 3 + h - d, g.pageV[nextPage] = !0, c.pageObjs[c.pageMv[d]].hasClass(
                      "cover") ? g.pageV[nextPage + 1] = !0 : (g.pageV[0] = !0, g.pageZ[0] = 3 + h + 1);
          else if (c.display == b.DISPLAY_DOUBLE) {
              for (d = 0; h > d; d++) {
              ...
              for (d = 0; i > d; d++)
                  for (f = a.view(c.front[d]), g.pageZ[c.front[d]] = 5 + h + d, e = 0; e < f.length; e++) g.pageV[
                      f[e]] = !0
          }
      } else {
          for (f = this.view(!1, !0), d = 0; d < f.length; d++) g.pageV[f[d]] = !0, g.pageZ[f[d]] = 2;
          c.display == b.DISPLAY_SINGLE ? f[0] < c.totalPages && (c.pages[f[0]].hasClass("cover") ? c.pages[f[0] +
              1] && !c.pages[f[0] + 1].hasClass("cover") && (g.pageV[f[0] + 1] = !0, g.pageZ[f[0] + 1] =
              2) : (g.pageV[f[0] + 1] = !0, g.pageZ[f[0] + 1] = 1)) : c.display == b.DISPLAY_DOUBLE && (f[0] >
              2 && (g.pageV[f[0] - 2] = !0, g.pageZ[f[0] - 2] = 1), f[1] < c.totalPages - 1 && (g.pageV[f[1] +
                  2] = !0, g.pageZ[f[1] + 2] = 1))
      }
      for (var k in c.pageWrap) b.has(k, c.pageWrap) && void 0 === g.pageV[k] && this._isCoverPageVisible(k) && (
      ...
      if (this.isAnimating() && 0 !== e.pageMv[0]) {
          ...
          for (c in e.pageWrap) b.has(c, e.pageWrap) && (e.pageWrap[c].css({
              ...
              zIndex: f.pageZ[c] || 0
          }), e.tpage ? e.pages[c].flip("hover", !1).flip("disable", -1 == a.inArray(parseInt(c, 10), e.pageMv) &&
              c != h[0] && c != h[1]) : e.pages[c].flip("hover", d).flip("disable", c != g[0] && c != g[1]))
      } else {
          d = e.options.hover;
          for (c in e.pageWrap) b.has(c, e.pageWrap) && (e.pageWrap[c].css({
              display: f.pageV[c] ? "" : "none",
              zIndex: f.pageZ[c] || 0
          }), e.pages[c] && (e.pages[c].flip("disable", e.disabled || 2 != f.pageZ[c]).flip("hover", d),
      ...
      var d = this._data,
          e = d.options.swipe;
      if (a.extend(d.options, c), c.pages && this.pages(c.pages), c.page && this.page(c.page), (c.margin || c.pageMargin) &&
          (this._calculateMargin(), this._resize()), c.display && this.display(c.display), c.direction && this.direction(
              c.direction), c.width && c.height && this.size(c.width, c.height), c.swipe === !0 && e ? this.$el.on(
              "swipe", a.proxy(this, "_eventSwipe")) : c.swipe === !1 && this.$el.off("swipe", this._eventSwipe),
          c.cornerPosition) {
      ...
      if (c.margin && this._resize.call(this), c.animatedAutoCenter === !0 ? this.$el.css(b.addCssWithPrefix({
          ...
          for (var g in c.delegate) b.has(g, c.delegate) && ("tap" == g || "doubletap" == g ? (this.$el.off(g,
              ".page"), this.$el.on(g, ".page", c.delegate[g])) : this.$el.off(g).on(g, c.delegate[g]));
      return this.$el
      ...
      var f, g, h, i = this._data,
          j = this.view();
      if (i.display == b.DISPLAY_DOUBLE ? (c = Math.floor(c), d = Math.floor(d), 1 == c % 2 && (c -= 1), h = Math
              .floor(c / 2)) : h = c, this.stop(), this.$el.css({
              width: c,
              height: d
          }), i.zoom > 1) {
          ...
          for (f in k) b.has(f, k) && (g = this._pageSize(f, !0), e || i.pageObjs[f].css({
              width: g.width,
              height: g.height
          }), i.pageWrap[f].css(g), i.pages[f] && (i.pages[f].flip("_restoreClip", !1, !0), i.pages[f].flip(
              "resize", g.width, g.height)))
      } else
          for (f in i.pageWrap) b.has(f, i.pageWrap) && (g = this._pageSize(f, !0), e && -1 != a.inArray(parseInt(
              f, 10), j) || i.pageObjs[f].css({
              width: g.width,
              height: g.height
          }), i.pageWrap[f].css(g), i.pages[f] && (i.pages[f].flip("_restoreClip"), i.pages[f].flip(
              "resize", g.width, g.height)));
      ...
      }, 0)) : this.center()), this.$el.css(this._position()), i.pages[0] && (f = i.pages[0].data("f").tPage,
          f && i.pageObjs[0].children().eq(0).css({
      ...
      if (this.isAnimating()) {
          ...
          for (d.tpage && (d.page = d.tpage, delete d.tpage); d.pageMv.length > 0;)
              if (c = d.pages[d.pageMv[0]], a = c.data("f")) {
                  var f = a.peel;
                  a.peel = null, c.flip("hideFoldedPage"), a.peel = f, a.next = e ? a.page + 1 : d.options.showDoublePage ?
                      0 === a.page % 2 ? a.page + 1 : a.page - 1 : 0 === a.page % 2 ? a.page - 1 : a.page + 1, c.flip(
                          "_bringClipToFront", !1)
      ...
      var f = this._data,
          g = a(c.target).data("f");
      return f.display == b.DISPLAY_SINGLE && e && (g.next = "l" == e.charAt(1) && f.direction == b.DIRECTION_LTR ||
          "r" == e.charAt(1) && f.direction == b.DIRECTION_RTL ? g.next < g.page ? g.next : g.page - 1 : g.next >
          g.page ? g.next : g.page + 1), c.isDefaultPrevented() ? (this._updateShadow(), void 0) : (this._updateShadow(),
          void 0)
      ...
      for (var d in c.pages)
          if (b.has(d, c.pages) && c.pages[d].flip("_pagePress", a)) return c.tmpListeners || (c.tmpListeners = {},
              c.tmpListeners.tap = b.getListeners(this.$el, "tap", !0), c.tmpListeners.doubleTap = b.getListeners(
                  this.$el, "doubleTap", !0)), a.preventDefault(), c.statusHolding = !0, void 0;
      ...
      if (e.finger) {
          ...
          e.tmpListeners || (e.tmpListeners = {}, e.tmpListeners.tap = b.getListeners(this.$el, "tap", !0), e.tmpListeners
                  .doubleTap = b.getListeners(this.$el, "doubleTap", !0)), e.finger = b.eventPoint(d), e.finger.prev =
              g, e.zoom > 1 && (!c || c && 1 == d.originalEvent.originalEvent.touches.length) && this.scroll(e.scroll
                  .left + e.finger.x - g.x, e.scroll.top + e.finger.y - g.y)
      } else if (!c && e.zoom > 1 && e.options.autoScroll) {
          e.initScroll || (e.initScroll = this.scroll(), e.initCursor = b.eventPoint(d), e.viewerOffset = e.options
              .viewer.offset());
          var h = b.eventPoint(d),
              i = b.point2D(e.initScroll.x, e.initScroll.y),
              j = this.scrollSize();
          h.x < e.initCursor.x ? i.x = e.initScroll.left * Math.max(0, (h.x - e.viewerOffset.left - 20) / e.initCursor
                  .x) : h.x > e.initCursor.x && (i.x = e.initScroll.left + (j.width - e.initScroll.left) * Math.min(
                  1, (h.x - e.initCursor.x + 20) / (e.viewerWidth - e.initCursor.x))), h.y < e.initCursor.y ? i.y =
              e.initScroll.top * Math.max(0, (h.y - e.viewerOffset.top - 20) / e.initCursor.y) : h.y > e.initCursor
              .y && (i.y = e.initScroll.top + (j.height - e.initScroll.top) * Math.min(1, (h.y - e.initCursor.y +
                  20) / (e.viewerHeight - e.initCursor.y))), this.scroll(i.x, i.y)
      }
  }, n.prototype._eventRelease = function (a) {
      var c = this,
          d = this._data;
      if (setTimeout(function () {
              d.tmpListeners && (b.setListeners(c.$el, "tap", d.tmpListeners.tap), b.setListeners(c.$el,
                  "doubleTap", d.tmpListeners.doubleTap), delete d.tmpListeners)
          }, 1), d.finger) {
          for (var e in d.pages) b.has(e, d.pages) && d.pages[e].flip("_pageUnpress", a);
          delete d.finger, delete d.fingerZoom, d.statusHolding && (d.statusHolding = !1, d.statusHover || this._hasMotionListener(
              !1)), d.zoomed && (this.zoom(d.zoomed[0], d.zoomed[1]), delete d.zoomed)
      }
      ...
      if ("turning" != d.status && 1 == d.zoom && d.hasSelection == e)
          if (d.display == b.DISPLAY_SINGLE) {
              ...
              } else c.speed > 0 && (~a.inArray(d.corner, b.corners.backward) ? this.previous() : (d.status =
                  "swiped", d.pages[f].flip("hideFoldedPage", !0)))
          } else d.display == b.DISPLAY_DOUBLE && (c.speed < 0 ? this.isAnimating() ? ~a.inArray(d.corner, b.corners
              .forward) && this.next() : this.next() : c.speed > 0 && (this.isAnimating() ? ~a.inArray(d.corner,
              b.corners.backward) && this.previous() : this.previous()))
      ...
      c.noHoverTimer = setTimeout(function () {
          c.statusHolding || (b._eventMove(a), b._hasMotionListener(!1)), delete c.noHoverTimer, c.statusHover = !
              1
      }, 10)
  }, n.prototype._hasMotionListener = function (b) {
      var c = this._data;
      b ? c.hasMoveListener || (a(document).on("vmousemove", a.proxy(this, "_eventMove")).on("vmouseup", a.proxy(
          this, "_eventRelease")), c.hasMoveListener = !0) : c.hasMoveListener && (a(document).off(
          "vmousemove", this._eventMove).off("vmouseup", this._eventRelease), c.hasMoveListener = !1)
  }, n.prototype.focusPoint = function () {
      var a = this._data;
      if (a.focusPoint) return a.focusPoint;
      var c = this.view();
      return c[0] ? c[1] ? b.point2D(this.width() / 2, this.height() / 2) : b.point2D(3 * this.width() / 4, this.height() /
          2) : b.point2D(this.width() / 4, this.height() / 2)
      ...
      if (d.zoom > 1 && !d.silentZoom) {
          ...
          c = Math.min(f.height, Math.max(0, c)), a = Math.min(f.width, Math.max(0, a)), this._trigger(
              "scrolling", a, c) != b.EVENT_PREVENTED && (g.x = g.x + f.width / 2 - a, g.y = g.y + f.height /
              2 - c, this.$el.css({
                  left: g.x,
                  top: g.y
              }), d.scroll = {
      ...
      if (e.silentZoom || this._trigger("willZoom", c, e.zoom) != b.EVENT_PREVENTED) {
          ...
          t && !l[0] && (v.x = v.x - f.width / 2), v = b.point2D(Math.min(u.x, Math.max(0, v.x)), Math.min(u.y,
              Math.max(0, v.y))), g && (n.left += r.width / 2);
          ...
          if (this.stop(), this.disable(!0), this._cloneView(!0), o) {
              ...
              if (e.zoomer.css(b.addCssWithPrefix({
                  ...
                  e.zoom = c, r = this._defaultSize(), r.width = r.width * m, r.height = r.height * m, e.zoom = m,
                      e.silentZoom = !1, delete e.initScroll, delete e.initCursor, e.peel = null, this.display(r.display),
                      this.size(r.width, r.height, e.options.autoScaleContent), this.scroll(v.x, v.y), 1 == m ? (
                          this.disable(!1), z && this.peel(z.corner, z.x, z.y, !0)) : e.peel = z, e.options.autoScaleContent &&
                      this.scaleContent(m), e.zoomer.css(b.addCssWithPrefix({
      ...
      for (var b = this._data, c = this.view(), d = 0; d < c.length; d++) c[d] && b.pageObjs[c[d]].transform(
          "scale(" + a + ")", "0% 0%")
      ...
      if (b.options.responsive && (e.top = b.viewerHeight / 2 - d.height / 2, e.left = b.viewerWidth / 2 - d.width /
              2, 1 == c)) {
          var f = b.margin;
          (e.top < f[0] || e.top + d.height > b.viewerHeight - f[2]) && (e.top = f[0]), (e.left < f[1] || e.left +
              d.width > b.viewerWidth - f[3]) && (e.left = f[3])
      }
      return e
      ...
      if (d.zoomer) c ? d.zoomer.show() : (d.zoomer.remove(), delete d.zoomer);
          ...
          for (g in i) b.has(g, i) && (e = this._pageSize(g, !0), e.position = "absolute", e.zIndex = d.pageWrap[
              g].css("z-index"), f = d.pageObjs[g].clone(), f.css(e), f.appendTo(j));
      ...
      var c, d, e, f, g, h, i, j, k, l, m, n, q, r = this.$el.data("f"),
          ...
          C = function () {
              ...
              var r = b.point2D(0, 0),
                  A = b.point2D(0, 0);
              if (r.x = c.x ? c.x - a.x : a.x, r.y = b.hasRotation ? c.y ? c.y - a.y : a.y : 0, A.x = e ? t - r.x /
                  2 : a.x + r.x / 2, A.y = r.y / 2, m = o - Math.atan2(r.y, r.x), j = m - Math.atan2(A.y, A.x), n =
                  Math.sin(j) * Math.sqrt(A.x * A.x + A.y * A.y), z = b.point2D(n * Math.sin(m), n * Math.cos(m)),
                  m > o) {
                  if (z.x = z.x + Math.abs(z.y * r.y / r.x), z.y = 0, Math.round(z.x * Math.tan(p - m)) < u)
                      return a.y = Math.sqrt(Math.pow(u, 2) + 2 * A.x * r.x), d && (a.y = u - a.y), C();
                  var D = p - m,
                      E = B - u / Math.sin(D);
                  x = b.point2D(Math.round(E * Math.cos(D)), Math.round(E * Math.sin(D))), e && (x.x = -x.x), d &&
                      (x.y = -x.y)
              }
              ...
              if (y = b.point2D(Math.round(e ? F - H : f + H), Math.round(d ? I : u - I)), s.options.gradients) {
                  ...
                  i = Math.sqrt(Math.pow(J.x - a.x, 2) + Math.pow(J.y - a.y, 2)) / t, g = Math.min(100, F * Math.sin(
                      m)), h = 1.3 * Math.min(F, G)
              }
          ...
          D = function (a, c, j, k) {
              ...
              if (r.ipage.css(o).transform(b.rotate(k) + b.translate(a.x + p, a.y, A), q), v.ipage.css(o).transform(
                      b.rotate(k) + b.translate(a.x + y.x - x.x - t * j[0] / 100, a.y + y.y - x.y - u * j[1] /
                          100, A) + b.rotate(Math.round(100 * (180 / k - 2) * k) / 100), q), r.clip.transform(b.translate(
                      -a.x + m - p, -a.y + n, A) + b.rotate(-k), q), v.clip.transform(b.translate(w - a.x + x.x +
                      m, -a.y + x.y + n, A) + b.rotate(-k), q), s.options.gradients) {
                  var z, C, D;
                  d ? e ? (C = k - 90, D = f - 50, g = -g, z = "50% 25%") : (C = k - 270, D = t - f - 50, z =
                      "50% 25%") : e ? (D = f - 50, C = k - 270, g = -g, z = "50% 75%") : (D = t - f - 50, C =
                      k - 90, z = "50% 75%");
                  var E = Math.max(.5, 2 - i);
                  E > 1 && (E = E >= 1.7 ? (2 - E) / .3 : 1), v.igradient.css({
                      opacity: Math.round(100 * E) / 100
                  }).transform(b.translate(D, 0, A) + b.rotate(C) + b.scale(g / 100, 1, A), z), d ? e ? (C = -
                      270 - k, h = -h, D = t - f - 20, z = "20% 25%") : (C = -90 - k, D = f - 20, z =
                      "20% 25%") : e ? (C = -90 - k, D = t - f - 20, h = -h, z = "20% 75%") : (C = 90 - k, D =
                      f - 20, z = "20% 75%"), E = .3 > i ? i / .3 : 1, r.ogradient.css({
                      opacity: Math.round(100 * E) / 100
      ...
      switch (r.point = b.peelingPoint(a.corner, a.x, a.y), a.corner) {
          case "l":
              m = a.y - r.startPoint.y, n = a.x, q = Math.atan2(m, n), q > 0 ? (j = r.startPoint.y, k = Math.sqrt(
                  n * n + m * m), l = 2 * j * Math.sin(q) + k, a.x = l * Math.cos(q), a.y = l * Math.sin(
                  q), a.corner = "tl", e = !0, d = !0, C(), D(z, [1, 0, 0, 1], [100, 0], w)) : (q = -q, j = u -
                  r.startPoint.y, k = Math.sqrt(n * n + m * m), l = 2 * j * Math.cos(o - q) + k, a.x = l *
                  Math.cos(q), a.y = u - l * Math.sin(q), a.corner = "bl", e = !0, C(), D(b.point2D(z.x, -z.y),
                      [1, 1, 0, 0], [100, 100], -w));
              break;
          case "r":
              m = r.startPoint.y - a.y, n = t - a.x, q = Math.atan2(m, n), 0 > q ? (j = r.startPoint.y, q = -q, k =
                  Math.sqrt(n * n + m * m), l = 2 * j * Math.sin(q) + k, a.x = t - l * Math.cos(q), a.y = l *
                  Math.sin(q), a.corner = "tr", d = !0, C(), D(b.point2D(-z.x, z.y), [0, 0, 0, 1], [0, 0], -w)
              ) : (j = u - r.startPoint.y, k = Math.sqrt(n * n + m * m), l = 2 * j * Math.cos(o - q) + k, a.x =
                  t - l * Math.cos(q), a.y = u - l * Math.sin(q), a.corner = "br", C(), D(b.point2D(-z.x, -z.y),
                      [0, 1, 1, 0], [0, 100], w));
              break;
          case "tl":
              d = !0, e = !0, a.x = Math.max(a.x, 1), r.point.x = a.x, c = this._startPoint("tl"), C(), D(z, [1,
                  0, 0, 1], [100, 0], w);
              break;
          case "tr":
              d = !0, a.x = Math.min(a.x, t - 1), r.point.x = a.x, C(), D(b.point2D(-z.x, z.y), [0, 0, 0, 1], [0,
                  0], -w);
              break;
          case "bl":
              e = !0, a.x = Math.max(a.x, 1), r.point.x = a.x, C(), D(b.point2D(z.x, -z.y), [1, 1, 0, 0], [100,
                  100], -w);
              break;
          case "br":
              a.x = Math.min(a.x, t - 1), r.point.x = a.x, C(), D(b.point2D(-z.x, -z.y), [0, 1, 1, 0], [0, 100],
                  w)
      }
      ...
      console.log(a.corner), d.ipage.css(b.addCssWithPrefix({
          "@transform": "rotateY(" + m + "deg) translate3d(0px, 0px, " + (this.$el.attr("depth") || 0) +
              "px)",
      ...
      var r = n.x ? (n.x - a.x) / e : a.x / e,
          ...
          u = c.next,
          v = d.pages[u].data("f");
      if (m ? (i = "0% 50%", j = "100% 50%", t ? (f = 0, k = c.next - 1, g = k > 0, l = c.page, h = 1) : (f =
              "100%", k = c.page + 1, g = o > k, l = c.next, h = 0)) : (i = "100% 50%", j = "0% 50%", s = -s, e = -
              e, t ? (f = 0, k = c.next + 1, l = c.page, g = o > k, h = 0) : (f = "-100%", k = c.page - 1, l = c.next,
                  g = k > 0, h = 1)), q[b.vendor + "perspective-origin"] = j, d.pageWrap[c.page].css(q), c.ipage.transform(
              "rotateY(" + s + "deg)" + "translate3d(0px, 0px, " + (this.$el.attr("depth") || 0) + "px)", j), d.pageWrap[
              u].css(b.addCssWithPrefix({
              overflow: "visible",
          ...
          c.igradient.parent()[0] != x.ipage[0] && c.igradient.appendTo(x.ipage), c.igradient.css({
              opacity: -r + 1
          }), b.gradient(c.igradient, b.point2D(100 * h, 0), b.point2D(100 * (-h + 1), 0), [[0,
  ...
  var r = b.UIComponent(function (c) {
      ...
      d.options = a.extend({
              ...
              value: 0,
              style: "horizontal"
          }, c), d.disabled = c.disabled === !0, "vertical" == d.options.style ? d.verticalStyle = !0 :
          "horizontal" == d.options.style && (d.verticalStyle = !1), this.$el.on("vmousedown", a.proxy(this,
              "_eventPress")), this.value(this._data.options.value), b.addDelegateList(c.delegate, this.$el)
  });
  r.prototype.value = function (a, c) {
      var d = this._data;
      if (void 0 === a) return d.value;
      var e;
      if (a = Math.min(d.options.max, Math.max(d.options.min, a)), a = Math.round(a / d.options.step), a *= d.options
          .step, d.pressed) a != d.pvalue && (c || this._trigger("slide", a) != b.EVENT_PREVENTED) && (e = 100 *
          ((a - d.options.min) / (d.options.max - d.options.min)), d.verticalStyle ? this.$el.find(
              ".progress").height(e + "%") : this.$el.find(".progress").width(e + "%"), d.pvalue = a);
      else if (a != d.value) {
          var f = c ? !0 : this._trigger("changeValue", a) != b.EVENT_PREVENTED;
          f ? (e = 100 * ((a - d.options.min) / (d.options.max - d.options.min)), d.value = a) : e = 100 * ((d.value -
                  d.options.min) / (d.options.max - d.options.min)), d.verticalStyle ? this.$el.find(".progress")
              .height(e + "%") : this.$el.find(".progress").width(e + "%")
      ...
      f.pressed = !0, f.pvalue = null, f.verticalStyle ? (d = b.eventPoint(c).y - g.offset().top, this.$el.addClass(
          "changing"), e = g.height()) : (d = b.eventPoint(c).x - g.offset().left, this.$el.addClass(
          "changing"), e = g.width()), this.value(this._percentToValue(d / e)), a(document).on("vmousemove",
          a.proxy(this, "_eventMoving")), a(document).on("vmouseup", a.proxy(this, "_eventRelease")), c.preventDefault()
  }, r.prototype._eventMoving = function (a) {
      var c, d = this._data;
      if (d.pressed && !d.disabled) {
          var e = this.$el.find(".progress").parent();
          if (d.verticalStyle ? (d.offset = b.eventPoint(a).y - e.offset().top, c = e.height()) : (d.offset = b.eventPoint(
                  a).x - e.offset().left, c = e.width()), !d.animationScheduled) {
              var f = this;
      ...
      b.pressed = !1, this._trigger("released"), b.pvalue ? this.value(b.pvalue) : this._trigger("valueUnchanged"),
          b.pvalue = null, this.$el.removeClass("changing"), a(document).off("vmousemove", this._eventMoving), a(
  ...
  var s = b.UIComponent(function (c) {
      ...
      var d = this._data;
      d.pages = [], d.reusablePages = [], d.listenToFlipbook = !0, d.focusedPage = 0, d.offsetX = 0, d.hasListeners = !
          1, d.options = a.extend({
              pageMargin: 10,
              duration: 500
              ...
              "class": "page-number"
          }), d.$container.appendTo(this.$el), d.$pageNumber.appendTo(this.$el), b.addDelegateList(c.delegate,
              this.$el), this._setValues(), d.disabled = c.disabled, this._addMiniature(), this._update(d.$flipbook
              .turn("page")), this._eventDelegation(), d.$flipbook.on("turned", a.proxy(this,
              "_eventPageTurned")), d.$flipbook.on("changeDisplay", a.proxy(this, "_eventChangeDisplay")), d.done = !
          0
  });
  s.prototype._addMiniature = function (b) {
      ...
      var c, d, e = this._data,
          f = a - 1,
          g = !0;
      if (!(e.focusedPage == a && e.done && !b || 1 > a || a > e.$flipbook.turn("pages") || (e.prevFocusedPage =
              e.focusedPage, e.focusedPage = a, e.disabled))) {
          for (e.focusedView = e.$flipbook.turn("view", e.focusedPage, !0), this._updateQueueReusablePages(), e.$pageNumber
              .html(e.focusedView.join("-")); this._isPageVisible(f);) c = this._findPage(f) || this._reusablePage(),
              null === c && (c = this._addMiniature()), this._updatePage(f, c, !0), f--, g = !1;
          for (f = a;
              (d = this._isPageVisible(f)) || g && f <= e.totalPages;) d && (c = this._findPage(f) || this._reusablePage(),
              null === c && (c = this._addMiniature()), this._updatePage(f, c, !0), g = !1), f++
      }
  }, s.prototype._updateQueueReusablePages = function () {
      for (var a, b = this._data, c = 0; c < b.pages.length; c++) a = b.pages[c], null !== a.pageNum && this._isPageVisible(
          a.pageNum, b.focusedPage) || (this._updatePage(a.pageNum, a, !0), this._isReusablePage(a) || b.reusablePages
          .push(a))
      ...
      if (null === b) this._updatePageX(c, -1e3);
          ...
          d && b != c.pageNum ? (g.removeClass("animated-page"), this._updatePageX(c, this._getPageOffsetLeft(b,
              f.prevFocusedPage)), setTimeout(function () {
              g.addClass("animated-page"), e._updatePageX(c, h)
          }, 0)) : (d && f.done ? g.addClass("animated-page") : g.removeClass("animated-page"), this._updatePageX(
              c, h)), -1 != a.inArray(b, f.focusedView) ? g.addClass("focused-page") : g.removeClass(
              "focused-page");
          var i = f.$flipbook.turn("view", b, !0);
          g.removeClass("left-page right-page single-page"), 2 == i.length ? i[0] == b ? g.addClass("left-page") :
              g.addClass("right-page") : g.addClass("single-page"), b != c.pageNum && (c.pageNum = b, g.attr(
                  "page", b), this._trigger("refreshPicture", b, g.find(".page-img")))
      }
      ...
      if (b = b || e.focusedPage, f) return e.scrollerWidth / 2 - e.pageWidth / 2 + (a - b) * (e.pageWidth + e.pageMargin) +
          e.offsetX;
      var g, h, i = e.$flipbook.turn("view", b, !0),
          j = b == a ? i : e.$flipbook.turn("view", a, !0),
          k = e.scrollerWidth / 2 - i.length * e.pageWidth / 2;
      if (a >= b) {
          for (g = i[i.length - 1], h = j[0] - 1, c = g; h >= c;) d = e.$flipbook.turn("view", c, !0), k += d.length *
              e.pageWidth + e.pageMargin, c = d[d.length - 1] + 1;
          return a == j[0] ? k + e.offsetX : k + e.pageWidth + e.offsetX
      }
      for (g = i[0] - 1, h = j[j.length - 1], c = g; c >= h;) d = e.$flipbook.turn("view", c, !0), k -= d.length *
          e.pageWidth + e.pageMargin, c = d[0] - 1;
      return a == j[0] ? k + e.offsetX : k + e.pageWidth + e.offsetX
      ...
      if (!a.disabled) {
          ...
          b.width = b.width / a.$flipbook.turn("view").length, a.scrollerWidth = a.$container.width(), a.pageHeight =
              a.$container.height(), a.pageWidth = Math.round(a.pageHeight * (b.width / b.height)), a.pageMargin =
              50, a.totalPages = a.$flipbook.turn("pages")
      }
  }, s.prototype._eventResize = function () {
      this.refresh()
  }, s.prototype._eventDelegation = function (b) {
      var c = this._data;
      b ? c.disabled || c.hasListeners || (c.hasListeners = !0, a(window).on("resize", a.proxy(this,
          "_eventResize")), this.$el.on("tap", ".ui-page", a.proxy(this, "_eventTap")), this.$el.on(
          "vmousedown", a.proxy(this, "_eventPress"))) : (c.hasListeners = !1, a(window).off("resize", this._eventResize),
          this.$el.off("tap", this._eventTap), this.$el.off("vmousedown", this._eventPress))
      ...
      var c = this._data;
      return this.animation && this.animation.stop(), a(document).on("vmousemove", a.proxy(this, "_eventMove")).on(
              "vmouseup", a.proxy(this, "_eventRelease")), c.x1 = b.pageX, c.x2 = c.x1, c.dxDistance = 0, c.timeStamp1 =
          b.timeStamp, c.timeStamp2 = b.timeStamp, !1
  }, s.prototype._eventMove = function (a) {
      var b = this._data;
      b.offsetX = b.offsetX + b.x2 - b.x1, b.done = !1, this._update(b.focusedPage, !0), b.done = !0, b.moving = !
          0, b.x1 = b.x2, b.x2 = a.pageX, b.timeStamp1 = b.timeStamp2, b.timeStamp2 = a.timeStamp
      ...
      var a = this._data;
      return a.done = !1, this._setValues(), this._update(a.focusedPage || a.$flipbook.turn("page"), !0), a.done = !
          0, a.forceRefresh = !1, this.$el
      ...
      var e = .002,
          ...
          g = f * f / (2 * e);
      return g *= 0 > a ? -1 : 1, a > 0 && g > c ? (g = c, f = f * c / g) : 0 > a && d > g && (g = d, f = f * d /
          g), {
          dist: g,
          time: Math.round(f / e)
      }
  ...
  t.prototype._eventDelegation = function (b) {
      b ? (this.$el.on("vmouseover", this._data.options.selector, a.proxy(this, "_eventHover")), this.$el.on(
          "vmouseout", this._data.options.selector, a.proxy(this, "_eventNoHover"))) : (this.$el.off(
          "vmouseover", this._eventHover), this.$el.off("vmouseout", this._eventNoHover))
      ...
      if (d && "" !== d) {
          ...
          e.$currentTarget && (e.$currentTarget.removeClass("has-hint"), e.$currentTarget = null), e.$tooltip ||
              (e.$tooltip = a("<div />", {
                  "class": f
              }), e.$tooltip.hide(), e.$tooltip.appendTo(a("body"))), e.$tooltip.html(d), e.isTooltipVisible || e
              .$tooltip.css({
                  visibility: "hidden",
                  display: ""
              });
          var g = e.$tooltip.width() + parseInt(e.$tooltip.css("padding-left"), 10) + parseInt(e.$tooltip.css(
                  "padding-right"), 10),
              h = e.$tooltip.height() + parseInt(e.$tooltip.css("padding-top"), 10) + parseInt(e.$tooltip.css(
                  "padding-bottom"), 10);
          e.isTooltipVisible || e.$tooltip.css({
              display: "none",
              visibility: ""
          });
          for (var i, j = c.offset(), k = c.width(), l = c.height(), m = a(window).width(), n = a(window).height(),
                  o = {
                      x: 0,
                      y: 0
          ...
          }, 1), c.addClass("has-hint"), e.isTooltipVisible = !0, "" !== c.attr("title") && (c.attr("v-title",
              d), c.removeAttr("title")), e.$currentTarget = c, e.hideTimeHandler && clearInterval(e.hideTimeHandler)
      }
  }, t.prototype._hideHint = function (a) {
      var b = this._data;
      b.hideTimeHandler = setTimeout(function () {
          b.isTooltipVisible = !1, b.$currentTarget = null, a.removeClass("has-hint"), b.$tooltip.removeClass(
              "ui-tooltip-visible"), setTimeout(function () {
              b.isTooltipVisible || b.$tooltip.hide()
          }, 200)
      }, 100)
  }, t.prototype.hide = function () {
      var a = this._data;
      a.isTooltipVisible && (a.isTooltipVisible = !1, a.$currentTarget.removeClass("has-hint"), a.$tooltip.removeClass(
          "ui-tooltip-visible"), a.$tooltip.hide(), a.$currentTarget = null)
  ...
  u.prototype._createDom = function () {
      ...
      this.$el.on("vmousedown", a.proxy(this, "_vmousedown")), this.$el.on("vmouseover", ".ui-menu-item", a.proxy(
              this, "_vmouseoverItem")), this.$el.on("vmouseout", ".ui-menu-item", a.proxy(this, "_vmouseoutItem")),
      ...
      var d = this._data;
      return 0 > a || a >= d.$items.length ? !1 : c || this._trigger("itemSelected", a) != b.EVENT_PREVENTED ? (
          null !== d.selectedItem && d.$items[d.selectedItem].removeClass("ui-selected-item"), d.selectedItem =
          a, d.$items[a].addClass("ui-selected-item"), this.$el) : !1
  }, u.prototype.clearSelection = function () {
      var a = this._data;
      return null !== a.selectedItem && a.$items[a.selectedItem].removeClass("ui-selected-item"), a.selectedItem =
          null, this.$el
      ...
      var b = this;
      return a(document).off("vmousedown", this.hide), this.$el.removeClass("ui-menu-visible"), setTimeout(
          function () {
